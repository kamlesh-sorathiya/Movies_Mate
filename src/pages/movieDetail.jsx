...
const MovieDetail = ({ apiPath }) => {
  ...
  const { data, loading } = useFetch(apiPath + '/' + params.id);
  let image = null;
  ...
  if (movie.poster_path) {
    image = IMAGE_PATH_URL + movie.poster_path;
  }
  else {
    image = noimage;
  }
      ...
      {loading ? <h1 className='mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white'> Loading...</h1> :
        <section className="flex justify-around flex-wrap py-5">
          ...
          <div className="max-w-2xl text-gray-700 text-lg dark:text-white text-center lg:text-left ">
            ...
            {movie.genres ? (
              <p className="my-7 flex   gap-2 justify-center lg:justify-start">
            ...
            <div className="flex items-center justify-center lg:justify-start">
              ...
              <p className="ml-2 text-gray-900 dark:text-white">{movie?.vote_average?.toFixed(1)} / 10</p>
